...
export class AccountUserListComponent implements OnInit {
  ...
  readonly allFields: FieldDefinition[] = [
    ...
    { name: 'name' , displayName: 'Message', type: 'string', defaultValue: '&quot;&quot;' , entityType: 'String'},
    { name: 'account' , displayName: 'Compte', type: 'string', defaultValue: '&quot;&quot;' , entityType: 'Account'},
    { name: 'username' , displayName: 'Partager avec (Nom identifiant)', type: 'string', defaultValue: '&quot;&quot;' , entityType: 'String'},
  ...
  readonly fieldsToDisplay: FieldDefinition[] = [
    { name: 'name', displayName: 'Message', type: 'string' , entityType: 'String' },
    { name: 'account', displayName: 'Compte', type: 'string' , entityType: 'Account' },
    { name: 'username', displayName: 'Partager avec (Nom identifiant)', type: 'string' , entityType: 'String' },
